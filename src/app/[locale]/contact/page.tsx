...
function useMapsUrls(address: string) {
    return useMemo(() => {
        ...
        return {
            ...
            mapsPlaceLink: `https://www.google.com/maps/search/?api=1&query=${q}`,
        }
    }, [address])
}
            ...
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
                ...
                >
                    ...
                    <motion.div
                        ...
                        whileInView="whileInView"
                        viewport={{ once: true, amount: 0.2 }}
                        className="flex flex-col gap-x-20 gap-y-5 sm:flex-row sm:items-center sm:justify-center mt-8"
                    >
                        <motion.div variants={card} className="w-full sm:w-auto">
                            <Button
                                asChild
