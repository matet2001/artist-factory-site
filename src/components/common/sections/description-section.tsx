        ...
        <section className="relative">
            <div className="w-full h-full text-center relative z-10">
                <motion.div
                    ...
                    className="bg-linear-to-br from-card to-card-elevated rounded-3xl px-4 sm:px-6 lg:px-8 pt-10 pb-15 relative w-full h-full section-height flex justify-center items-center overflow-hidden border border-primary/20 shadow-2xl"
                >
                    {/* Scattered Logos */}
