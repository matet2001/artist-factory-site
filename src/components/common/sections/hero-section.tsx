...
export default function HeroSection() {
    ...
    return (
        <>
            <section className="absolute left-0 right-0 min-h-screen flex flex-col -mt-[var(--header-height)] overflow-hidden z-10">
                {/* Main content area */}
                <div className="flex-1 relative flex items-center justify-center">
                    ...
                    <div
                        className="absolute inset-0 w-full h-full bg-no-repeat bg-fixed block sm:hidden"
                        style={{
                            backgroundImage: "url('/decorations/AF01-mobile.png')",
                            backgroundSize: '65% auto',
                            backgroundPosition: 'center calc(15% + var(--header-height))',
                        }}
                        aria-hidden="true"
                    />
